...
"use strict";var fs=require("fs"),unified=require("unified"),parse=require("remark-parse"),math=require("remark-math"),katex=require("rehype-katex"),stringify=require("rehype-stringify"),remark2rehype=require("remark-rehype"),inspect=require("unist-util-inspect"),htmlBlocks=require("./packages/html-blocks"),escapeEscaped=require("./packages/escape-escaped"),kbd=require("./packages/kbd"),customBlocks=require("./packages/custom-blocks"),fromFile=function(e){return fs.readFileSync(e)},logO=function(){for(var e=arguments.length,r=Array(e),i=0;i<e;i++)r[i]=arguments[i];return r.forEach(function(e){return console.log(JSON.stringify(e,null,2))})},processor=unified().use(parse,{gfm:!0,commonmark:!1,yaml:!1,footnotes:!0,blocks:[]}).use(remark2rehype,{allowDangerousHTML:!0}).use(customBlocks({secret:"spoiler",s:"spoiler",information:"information ico-after",i:"information ico-after",question:"question ico-after",q:"question ico-after",attention:"warning ico-after",a:"warning ico-after",erreur:"error ico-after",e:"error ico-after"})).use(math).use(htmlBlocks).use(escapeEscaped()).use(kbd).use(katex).use(stringify),getAST=function(e){var r=processor.parse(e);return processor.runSync(r)},render=function(e){return processor.stringify(e)};module.exports={getAST:getAST,inspect:inspect,renderFile:function(e){return render(getAST(fromFile(e)))},renderString:function(e){return render(getAST(e))}};

},{"./packages/custom-blocks":216,"./packages/escape-escaped":217,"./packages/html-blocks":219,"./packages/kbd":220,"fs":3,"rehype-katex":115,"rehype-stringify":131,"remark-math":133,"remark-parse":135,"remark-rehype":184,"unified":196,"unist-util-inspect":201}],2:[function(require,module,exports){
...
},{"unist-util-visit":206}],220:[function(require,module,exports){
arguments[4][217][0].apply(exports,arguments)
},{"./inline":221,"dup":217}],221:[function(require,module,exports){
