...
"use strict";function parseMathHtml(r){return unified().use(parse,{fragment:!0,position:!1}).parse(r)}var visit=require("unist-util-visit"),katex=require("katex"),unified=require("unified"),parse=require("rehype-parse"),position=require("unist-util-position");module.exports=function(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return null==r.throwOnError&&(r.throwOnError=!1),function(e,i){return visit(e,"element",function(e){var t="span"===e.tagName&&e.properties.className&&e.properties.className.includes("inlineMath"),a="div"===e.tagName&&"math"===e.properties.className;if(t||a){var s=void 0;try{s=katex.renderToString(e.children[0].value,{displayMode:a})}catch(t){if(r.throwOnError)throw t;i.message(t.message,position.start(e)),s=katex.renderToString(e.children[0].value,{displayMode:a,throwOnError:!1,errorColor:r.errorColor},"katex-parse-error")}var n=parseMathHtml(s).children[0];Object.assign(e.properties,{className:e.properties.className}),e.children=[n]}}),e}};
