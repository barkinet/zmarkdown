...
"use strict";var fs=require("fs"),unified=require("unified"),reParse=require("remark-parse"),math=require("remark-math"),katex=require("rehype-katex"),stringify=require("rehype-stringify"),remark2rehype=require("remark-rehype"),inspect=require("unist-util-inspect"),headingShifter=require("./packages/heading-shift"),htmlBlocks=require("./packages/html-blocks"),escapeEscaped=require("./packages/escape-escaped"),kbd=require("./packages/kbd"),customBlocks=require("./packages/custom-blocks"),subSuper=require("./packages/sub-super"),fromFile=function(e){return fs.readFileSync(e)},processor=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.headingShift;return unified().use(reParse,{gfm:!0,commonmark:!1,yaml:!1,footnotes:!0,blocks:[]}).use(headingShifter(r||0)).use(remark2rehype,{allowDangerousHTML:!0}).use(customBlocks({secret:"spoiler",s:"spoiler",information:"information ico-after",i:"information ico-after",question:"question ico-after",q:"question ico-after",attention:"warning ico-after",a:"warning ico-after",erreur:"error ico-after",e:"error ico-after"})).use(math).use(htmlBlocks).use(escapeEscaped()).use(kbd).use(subSuper).use(katex).use(stringify)},parse=function(e){return function(r){return processor(e).parse(r)}},transform=function(e){return function(r){return processor(e).runSync(r)}},render=function(e){return function(r){return processor(e).stringify(r)}},renderString=function(e){return function(r){return render(e)(transform(e)(parse(e)(r)))}},renderFile=function(e){return function(r){return renderString(e)(fromFile(r))}};module.exports=function(e){return{inspect:inspect,parse:parse(e),transform:transform(e),renderFile:renderFile(e),renderString:renderString(e)}};

},{"./packages/custom-blocks":216,"./packages/escape-escaped":217,"./packages/heading-shift":219,"./packages/html-blocks":221,"./packages/kbd":222,"./packages/sub-super":224,"fs":3,"rehype-katex":115,"rehype-stringify":131,"remark-math":133,"remark-parse":135,"remark-rehype":184,"unified":196,"unist-util-inspect":201}],2:[function(require,module,exports){
...
"use strict";function ccount(r,t){var e,n=0;if(r=String(r),"string"!=typeof t||1!==t.length)throw new Error("Expected character");for(e=r.indexOf(t);e!==-1;)n++,e=r.indexOf(t,e+1);return n}module.exports=ccount;
...
},{"repeat-string":185}],12:[function(require,module,exports){
...
},{"camelcase":16,"has":14,"hastscript":37,"property-information":114,"vfile-location":210}],16:[function(require,module,exports){
...
"use strict";function isElement(t,e){var o;if(!(null===e||void 0===e||"string"==typeof e||"object"===(void 0===e?"undefined":_typeof(e))&&e.length))throw new Error("Expected `string` or `Array.<string>` for `tagNames`, not `"+e+"`");return!(!t||"object"!==(void 0===t?"undefined":_typeof(t))||"element"!==t.type||"string"!=typeof t.tagName)&&(null===e||void 0===e||(o=t.tagName,"string"==typeof e?o===e:e.indexOf(o)!==-1))}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};module.exports=isElement;
...
},{"./omission":26,"./one":33,"html-void-elements":40}],25:[function(require,module,exports){
...
},{"./omission":27,"./util/siblings":31,"./util/white-space-left":32,"hast-util-is-element":17,"unist-util-is":202}],26:[function(require,module,exports){
...
"use strict";function omission(r){function s(s,e,i){var n=s.tagName,o=!!has(r,n)&&r[n];return!!o&&o(s,e,i)}return s}var has=require("has");module.exports=omission;

},{"has":14}],28:[function(require,module,exports){
"use strict";function html(e){var t=first(e);return!t||!is("comment",t)}function head(e){for(var t,r,i=e.children,o=i.length,l={},n=-1;++n<o;)if(t=i[n],r=t.tagName,"element"===t.type&&("title"===r||"base"===r)){if(has(l,r))return!1;l[r]=!0}return Boolean(o)}function body(e){var t=first(e,!0);return!t||!is("comment",t)&&!whiteSpaceLeft(t)&&!element(t,["meta","link","script","style","template"])}function colgroup(e,t,r){var i=before(r,t),o=first(e,!0);return(!element(i,"colgroup")||!closing(i,place(r,i),r))&&(o&&element(o,"col"))}function tbody(e,t,r){var i=before(r,t),o=first(e);return(!element(i,["thead","tbody"])||!closing(i,place(r,i),r))&&(o&&element(o,"tr"))}var has=require("has"),is=require("unist-util-is"),element=require("hast-util-is-element"),before=require("./util/siblings").before,first=require("./util/first"),place=require("./util/place"),whiteSpaceLeft=require("./util/white-space-left"),closing=require("./closing"),omission=require("./omission");module.exports=omission({html:html,head:head,body:body,colgroup:colgroup,tbody:tbody});

},{"./closing":25,"./omission":27,"./util/first":29,"./util/place":30,"./util/siblings":31,"./util/white-space-left":32,"has":14,"hast-util-is-element":17,"unist-util-is":202}],29:[function(require,module,exports){
...
},{"hast-util-whitespace":36,"unist-util-is":202}],33:[function(require,module,exports){
"use strict";function one(e,r,n,t){var o=r&&r.type;if(!o)throw new Error("Expected node, not `"+r+"`");if(!has(handlers,o))throw new Error("Cannot compile unknown node `"+o+"`");return handlers[o](e,r,n,t)}var has=require("has");module.exports=one;var handlers={};handlers.root=require("./all"),handlers.text=require("./text"),handlers.element=require("./element"),handlers.doctype=require("./doctype"),handlers.comment=require("./comment"),handlers.raw=require("./raw");

},{"./all":20,"./comment":21,"./doctype":22,"./element":23,"./raw":34,"./text":35,"has":14}],34:[function(require,module,exports){
...
},{"stringify-entities":190,"xtend":214}],36:[function(require,module,exports){
...
},{"camelcase":38,"comma-separated-tokens":10,"hast-util-parse-selector":18,"property-information":114,"space-separated-tokens":187}],38:[function(require,module,exports){
...
"use strict";module.exports=require("./index.json");
...
},{"is-alphabetical":42,"is-decimal":45}],44:[function(require,module,exports){
...
},{"./ParseError":55,"match-at":77}],53:[function(require,module,exports){
...
},{"./Lexer":52}],54:[function(require,module,exports){
...
},{"./Style":58,"./fontMetricsData":67,"./unicodeRegexes":73}],67:[function(require,module,exports){
...
},{"./Parser":56}],72:[function(require,module,exports){
...
"use strict";function getDefinitionFactory(t,i){return getterFactory(gather(t,i))}function gather(t,i){function e(t){var i=normalise(t.identifier);has(n,i)||(n[i]=t)}function r(t){n[normalise(t.identifier)]=t}var n={};if(!t||!t.type)throw new Error("mdast-util-definitions expected node");return visit(t,"definition",i&&i.commonmark?e:r),n}function getterFactory(t){function i(i){var e=i&&normalise(i);return e&&has(t,e)?t[e]:null}return i}function normalise(t){return t.toUpperCase()}var visit=require("unist-util-visit"),has=require("has");module.exports=getDefinitionFactory;

},{"has":14,"unist-util-visit":206}],79:[function(require,module,exports){
"use strict";module.exports=require("./lib/index.js");

},{"./lib/index.js":106}],80:[function(require,module,exports){
...
},{"./one":107,"trim":193}],81:[function(require,module,exports){
...
},{"./all":80,"unist-builder":199}],82:[function(require,module,exports){
...
},{"./handlers/list":99,"./handlers/thematic-break":105,"./wrap":108}],83:[function(require,module,exports){
...
},{"unist-builder":199}],92:[function(require,module,exports){
"use strict";function imageReference(e,i){var r=e.definition(i.identifier),a={src:normalize(r&&r.url||""),alt:i.alt};return r&&null!=r.title&&(a.title=r.title),failsafe(e,i,r)||e(i,"img",a)}module.exports=imageReference;var normalize=require("normalize-uri"),failsafe=require("../failsafe");

},{"../failsafe":81,"normalize-uri":109}],93:[function(require,module,exports){
"use strict";function image(e,r){var i={src:normalize(r.url),alt:r.alt};return null!=r.title&&(i.title=r.title),e(r,"img",i)}var normalize=require("normalize-uri");module.exports=image;

},{"normalize-uri":109}],94:[function(require,module,exports){
...
},{"./blockquote":83,"./break":84,"./code":85,"./delete":86,"./emphasis":87,"./footnote":89,"./footnote-reference":88,"./heading":90,"./html":91,"./image":93,"./image-reference":92,"./inline-code":95,"./link":97,"./link-reference":96,"./list":99,"./list-item":98,"./paragraph":100,"./root":101,"./strong":102,"./table":103,"./text":104,"./thematic-break":105}],95:[function(require,module,exports){
...
},{"collapse-white-space":9,"unist-builder":199}],96:[function(require,module,exports){
"use strict";function linkReference(e,i){var l=e.definition(i.identifier),r={href:normalize(l&&l.url||"")};return l&&null!=l.title&&(r.title=l.title),failsafe(e,i,l)||e(i,"a",r,all(e,i))}module.exports=linkReference;var normalize=require("normalize-uri"),failsafe=require("../failsafe"),all=require("../all");

},{"../all":80,"../failsafe":81,"normalize-uri":109}],97:[function(require,module,exports){
"use strict";function link(l,r){var e={href:normalize(r.url)};return null!=r.title&&(e.title=r.title),l(r,"a",e,all(l,r))}var normalize=require("normalize-uri"),all=require("../all");module.exports=link;

},{"../all":80,"normalize-uri":109}],98:[function(require,module,exports){
"use strict";function listItem(e,l,t){var r,i=l.children,n=i[0],a=(!t||!t.loose)&&n&&n.children&&1===i.length,s=all(e,a?n:l),c={};return"boolean"==typeof l.checked&&(a||n&&"paragraph"===n.type||s.unshift(e(null,"p",[])),r=a?s:s[0].children,0!==r.length&&r.unshift(u("text"," ")),r.unshift(e(null,"input",{type:"checkbox",checked:l.checked,disabled:!0})),c.className=["task-list-item"]),a||0===s.length||(s=wrap(s,!0)),e(l,"li",c,s)}module.exports=listItem;var u=require("unist-builder"),wrap=require("../wrap"),all=require("../all");

},{"../all":80,"../wrap":108,"unist-builder":199}],99:[function(require,module,exports){
...
},{"../all":80,"../wrap":108,"unist-builder":199}],102:[function(require,module,exports){
"use strict";function strong(r,t){return r(t,"strong",all(r,t))}module.exports=strong;var all=require("../all");

},{"../all":80}],103:[function(require,module,exports){
...
},{"../all":80,"../wrap":108,"unist-util-position":203}],104:[function(require,module,exports){
...
},{"unist-builder":199}],109:[function(require,module,exports){
...
},{"../tokenizer":127,"./html":119}],119:[function(require,module,exports){
...
},{"../common/doctype":117,"../common/foreign_content":118,"../common/html":119,"../common/merge_options":120,"../common/unicode":121,"../location_info/parser_mixin":122,"../tokenizer":127,"../tree_adapters/default":130,"./formatting_element_list":124,"./open_element_stack":126}],126:[function(require,module,exports){
...
},{"../common/html":119}],127:[function(require,module,exports){
...
},{"../common/unicode":121,"../location_info/tokenizer_mixin":123,"./named_entity_trie":128,"./preprocessor":129}],128:[function(require,module,exports){
...
},{"hast-util-to-html":19,"xtend":214}],132:[function(require,module,exports){
"use strict";var trim=require("trim-trailing-lines"),C_NEWLINE="\n",C_TAB="\t",C_SPACE=" ",C_DOLLAR="$",MIN_FENCE_COUNT=2,CODE_INDENT_COUNT=4;module.exports=function(){function t(t,e,r){for(var i,o,a,n,h,C,f,c,l,p,s=e.length+1,N=0,_="";N<s&&((a=e.charAt(N))===C_SPACE||a===C_TAB);)_+=a,N++;if(l=N,(a=e.charAt(N))===C_DOLLAR){for(N++,o=a,i=1,_+=a;N<s&&(a=e.charAt(N))===o;)_+=a,i++,N++;if(!(i<MIN_FENCE_COUNT)){for(;N<s&&(a=e.charAt(N))!==C_NEWLINE;){if(a===C_DOLLAR)return;_+=a,N++}if(a=e.charAt(N),r)return!0;for(p=t.now(),p.column+=_.length,p.offset+=_.length,n=f=c=h=C="";N<s;)if(a=e.charAt(N),h+=f,C+=c,f=c="",a===C_NEWLINE){for(h?(f+=a,c+=a):_+=a,n="",N++;N<s&&(a=e.charAt(N))===C_SPACE;)n+=a,N++;if(f+=n,c+=n.slice(l),!(n.length>=CODE_INDENT_COUNT)){for(n="";N<s&&(a=e.charAt(N))===o;)n+=a,N++;if(f+=n,c+=n,!(n.length<i)){for(n="";N<s&&(a=e.charAt(N))!==C_NEWLINE;)f+=a,c+=a,N++;break}}}else h+=a,c+=a,N++;_+=h+f;var u=trim(C);return t(_)({type:"math",value:u,data:{hName:"div",hProperties:{className:"math"},hChildren:[{type:"text",value:u}]}})}}}var e=(arguments.length>0&&void 0!==arguments[0]&&arguments[0],this.Parser),r=e.prototype.blockTokenizers,i=e.prototype.blockMethods;r.math=t,i.splice(i.indexOf("fencedCode")+1,0,"math");var o=e.prototype.interruptParagraph,a=e.prototype.interruptList,n=e.prototype.interruptBlockquote;o.splice(o.indexOf("fencedCode")+1,0,["math"]),a.splice(a.indexOf("fencedCode")+1,0,["math"]),n.splice(n.indexOf("fencedCode")+1,0,["math"]);var h=this.Compiler;if(null!=h){h.prototype.visitors.math=function(t){return"$$\n"+t.value+"\n$$"}}};

},{"trim-trailing-lines":192}],133:[function(require,module,exports){
"use strict";var inlinePlugin=require("./inline"),blockPlugin=require("./block");module.exports=[[inlinePlugin],[blockPlugin]];

},{"./block":132,"./inline":134}],134:[function(require,module,exports){
"use strict";function locator(e,t){return e.indexOf("$",t)}var ESCAPED_INLINE_MATH=/^\\\$/,INLINE_MATH=/^\$((?:\\\$|[^$])+)\$/,INLINE_MATH_DOUBLE=/^\$\$((?:\\\$|[^$])+)\$\$/;module.exports=function(){function e(e,t,i){var r=INLINE_MATH_DOUBLE.exec(t)||INLINE_MATH.exec(t),n=ESCAPED_INLINE_MATH.exec(t);if(n)return!!i||e(n[0])({type:"text",value:"$"});if(r){if(i)return!0;var a=r[1].trim();return e(r[0])({type:"inlineMath",value:a,data:{hName:"span",hProperties:{className:"inlineMath"},hChildren:[{type:"text",value:a}]}})}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];e.locator=locator;var t=this.Parser,i=t.prototype.inlineTokenizers,r=t.prototype.inlineMethods;i.math=e,r.splice(r.indexOf("text"),0,"math");var n=this.Compiler;if(null!=n){n.prototype.visitors.inlineMath=function(e){return"$"+e.value+"$"}}};
...
},{"./lib/parser.js":149,"unherit":195,"xtend":214}],136:[function(require,module,exports){
module.exports=[
  "address",
  "article",
  "aside",
...
},{"parse-entities":111}],138:[function(require,module,exports){
...
},{"./block-elements":136}],139:[function(require,module,exports){
...
"use strict";function locate(e,t){var n=e.indexOf("*",t),o=e.indexOf("_",t);return o===-1?n:n===-1?o:o<n?o:n}module.exports=locate;

},{}],143:[function(require,module,exports){
"use strict";function locate(e,t){return e.indexOf("\\",t)}module.exports=locate;

},{}],144:[function(require,module,exports){
"use strict";function locate(e,t){var n=e.indexOf("[",t),o=e.indexOf("![",t);return o===-1?n:n<o?n:o}module.exports=locate;

},{}],145:[function(require,module,exports){
"use strict";function locate(e,t){var n=e.indexOf("**",t),o=e.indexOf("__",t);return o===-1?n:n===-1?o:o<n?o:n}module.exports=locate;

},{}],146:[function(require,module,exports){
"use strict";function locate(e,t){return e.indexOf("<",t)}module.exports=locate;

},{}],147:[function(require,module,exports){
"use strict";function locate(t,O){var e,o=PROTOCOLS.length,r=-1,i=-1;if(!this.options.gfm)return-1;for(;++r<o;)(e=t.indexOf(PROTOCOLS[r],O))!==-1&&(e<i||i===-1)&&(i=e);return i}module.exports=locate;var PROTOCOLS=["https://","http://","mailto:"];
...
},{"unist-util-remove-position":204,"xtend":214}],149:[function(require,module,exports){
...
},{"./decode":137,"./defaults":138,"./parse":148,"./set-options":150,"./tokenize/auto-link":151,"./tokenize/blockquote":152,"./tokenize/break":153,"./tokenize/code-fenced":154,"./tokenize/code-indented":155,"./tokenize/code-inline":156,"./tokenize/definition":157,"./tokenize/delete":158,"./tokenize/emphasis":159,"./tokenize/escape":160,"./tokenize/footnote-definition":161,"./tokenize/heading-atx":162,"./tokenize/heading-setext":163,"./tokenize/html-block":164,"./tokenize/html-inline":165,"./tokenize/link":166,"./tokenize/list":167,"./tokenize/newline":168,"./tokenize/paragraph":169,"./tokenize/reference":170,"./tokenize/strong":171,"./tokenize/table":172,"./tokenize/text":173,"./tokenize/thematic-break":174,"./tokenize/url":175,"./tokenize/yaml":176,"./tokenizer":177,"./unescape":178,"state-toggle":188,"vfile-location":210,"xtend":214}],150:[function(require,module,exports){
...
},{"./defaults":138,"markdown-escapes":76,"xtend":214}],151:[function(require,module,exports){
...
},{"../locate/tag":146,"parse-entities":111}],152:[function(require,module,exports){
...
},{"../util/interrupt":181,"trim":193}],153:[function(require,module,exports){
...
},{"../locate/break":139}],154:[function(require,module,exports){
...
},{"trim-trailing-lines":192}],155:[function(require,module,exports){
"use strict";function indentedCode(e,r,t){for(var C,i,E,N=-1,a=r.length,_="",n="",A="",l="";++N<a;)if(C=r.charAt(N),E)if(E=!1,_+=A,n+=l,A=l="",C===C_NEWLINE)A=l=C;else for(_+=C,n+=C;++N<a;){if(!(C=r.charAt(N))||C===C_NEWLINE){l=A=C;break}_+=C,n+=C}else if(C===C_SPACE&&r.charAt(N+1)===C&&r.charAt(N+2)===C&&r.charAt(N+3)===C)A+=CODE_INDENT,N+=3,E=!0;else if(C===C_TAB)A+=C,E=!0;else{for(i="";C===C_TAB||C===C_SPACE;)i+=C,C=r.charAt(++N);if(C!==C_NEWLINE)break;A+=i+C,l+=C}if(n)return!!t||e(_)({type:"code",lang:null,value:trim(n)})}var repeat=require("repeat-string"),trim=require("trim-trailing-lines");module.exports=indentedCode;var C_NEWLINE="\n",C_TAB="\t",C_SPACE=" ",CODE_INDENT_COUNT=4,CODE_INDENT=repeat(C_SPACE,CODE_INDENT_COUNT);

},{"repeat-string":185,"trim-trailing-lines":192}],156:[function(require,module,exports){
...
},{"../locate/code-inline":140,"is-whitespace-character":49}],157:[function(require,module,exports){
...
},{"../util/normalize":182,"is-whitespace-character":49}],158:[function(require,module,exports){
...
},{"../util/normalize":182,"is-whitespace-character":49}],162:[function(require,module,exports){
...
"use strict";function blockHTML(e,t,i){for(var r,s,o,l,n,C,c,a=this,f=a.options.blocks,p=t.length,E=0,T=[[/^<(script|pre|style)(?=(\s|>|$))/i,/<\/(script|pre|style)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Za-z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+f.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(openCloseTag.source+"\\s*$"),/^$/,!1]];E<p&&((l=t.charAt(E))===C_TAB||l===C_SPACE);)E++;if(t.charAt(E)===C_LT){for(r=t.indexOf(C_NEWLINE,E+1),r=r===-1?p:r,s=t.slice(E,r),o=-1,n=T.length;++o<n;)if(T[o][0].test(s)){C=T[o];break}if(C){if(i)return C[2];if(E=r,!C[1].test(s))for(;E<p;){if(r=t.indexOf(C_NEWLINE,E+1),r=r===-1?p:r,s=t.slice(E+1,r),C[1].test(s)){s&&(E=r);break}E=r}return c=t.slice(0,E),e(c)({type:"html",value:c})}}}var openCloseTag=require("../util/html").openCloseTag;module.exports=blockHTML;var C_TAB="\t",C_SPACE=" ",C_NEWLINE="\n",C_LT="<";

},{"../util/html":180}],165:[function(require,module,exports){
...
},{"../util/get-indentation":179,"../util/interrupt":181,"../util/remove-indentation":183,"is-decimal":45,"repeat-string":185,"trim":193}],168:[function(require,module,exports){
...
},{"is-whitespace-character":49}],169:[function(require,module,exports){
...
},{"../locate/strong":145,"is-whitespace-character":49,"trim":193}],172:[function(require,module,exports){
"use strict";function table(e,_,t){var i,E,l,A,L,r,n,N,C,I,f,h,s,T,a,c,B,o,u,O,p,G,S,g,P=this;if(P.options.gfm){for(i=o=0,r=_.length+1,n=[];i<r;){if(G=_.indexOf(C_NEWLINE,i),S=_.indexOf(C_PIPE,i+1),G===-1&&(G=_.length),S===-1||S>G){if(o<MIN_TABLE_ROWS)return;break}n.push(_.slice(i,G)),o++,i=G+1}for(A=n.join(C_NEWLINE),E=n.splice(1,1)[0]||[],i=0,r=E.length,o--,l=!1,f=[];i<r;){if((C=E.charAt(i))===C_PIPE){if(I=null,l===!1){if(g===!1)return}else f.push(l),l=!1;g=!1}else if(C===C_DASH)I=!0,l=l||TABLE_ALIGN_NONE;else if(C===C_COLON)l=l===TABLE_ALIGN_LEFT?TABLE_ALIGN_CENTER:I&&l===TABLE_ALIGN_NONE?TABLE_ALIGN_RIGHT:TABLE_ALIGN_LEFT;else if(!whitespace(C))return;i++}if(l!==!1&&f.push(l),!(f.length<MIN_TABLE_COLUMNS)){if(t)return!0;for(B=-1,O=[],p=e(A).reset({type:"table",align:f,children:O});++B<o;){for(u=n[B],L={type:"tableRow",children:[]},B&&e(C_NEWLINE),e(u).reset(L,p),r=u.length+1,i=0,N=h="",s=!0,T=a=null;i<r;)if((C=u.charAt(i))!==C_TAB&&C!==C_SPACE){if(""===C||C===C_PIPE)if(s)e(C);else{if(C&&a){N+=C,i++;continue}!h&&!C||s||(A=h,N.length>1&&(C?(A+=N.slice(0,N.length-1),N=N.charAt(N.length-1)):(A+=N,N="")),c=e.now(),e(A)({type:"tableCell",children:P.tokenizeInline(h,c)},L)),e(N+C),N=h=""}else if(N&&(h+=N,N=""),h+=C,C===C_BACKSLASH&&i!==r-2&&(h+=u.charAt(i+1),i++),C===C_TICK){for(T=1;u.charAt(i+1)===C;)h+=C,i++,T++;a?T>=a&&(a=0):a=T}s=!1,i++}else h?N+=C:e(C),i++;B||e(C_NEWLINE+E)}return p}}}var whitespace=require("is-whitespace-character");module.exports=table,table.notInList=!0;var C_BACKSLASH="\\",C_TICK="`",C_DASH="-",C_PIPE="|",C_COLON=":",C_SPACE=" ",C_NEWLINE="\n",C_TAB="\t",MIN_TABLE_COLUMNS=2,MIN_TABLE_ROWS=2,TABLE_ALIGN_LEFT="left",TABLE_ALIGN_CENTER="center",TABLE_ALIGN_RIGHT="right",TABLE_ALIGN_NONE=null;

},{"is-whitespace-character":49}],173:[function(require,module,exports){
...
},{"../locate/url":147,"is-whitespace-character":49,"parse-entities":111}],176:[function(require,module,exports){
...
"use strict";var attributeName="[a-zA-Z_:][a-zA-Z0-9:._-]*",unquoted="[^\"'=<>`\\x00-\\x20]+",singleQuoted="'[^']*'",doubleQuoted='"[^"]*"',attributeValue="(?:"+unquoted+"|"+singleQuoted+"|"+doubleQuoted+")",attribute="(?:\\s+"+attributeName+"(?:\\s*=\\s*"+attributeValue+")?)",openTag="<[A-Za-z][A-Za-z0-9\\-]*"+attribute+"*\\s*\\/?>",closeTag="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",comment="<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->",processing="<[?].*?[?]>",declaration="<![A-Za-z]+\\s+[^>]*>",cdata="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>";exports.openCloseTag=new RegExp("^(?:"+openTag+"|"+closeTag+")"),exports.tag=new RegExp("^(?:"+openTag+"|"+closeTag+"|"+comment+"|"+processing+"|"+declaration+"|"+cdata+")");
...
},{"collapse-white-space":9}],183:[function(require,module,exports){
...
},{"./get-indentation":179,"repeat-string":185,"trim":193}],184:[function(require,module,exports){
"use strict";function attacher(t,r){return t&&!t.process&&(r=t,t=null),t?bridge(t,r):mutate(r)}function bridge(t,r){function n(n,u,e){function a(t){e(t)}t.run(mdast2hast(n,r),u,a)}return n}function mutate(t){function r(r){return mdast2hast(r,t)}return r}var mdast2hast=require("mdast-util-to-hast");module.exports=attacher;

},{"mdast-util-to-hast":79}],185:[function(require,module,exports){
...
},{"path":112}],187:[function(require,module,exports){
...
},{"trim":193}],188:[function(require,module,exports){
...
},{"object-assign":110}],200:[function(require,module,exports){
...
"use strict";function noColor(o,n){return stripColor(inspect(o,n))}function inspect(o,n){var t,r,e,i;if(o&&o.length&&"string"!=typeof o){for(i=o.length,e=-1,t=[];++e<i;)t[e]=inspect(o[e]);return t.join("\n")}if(!o||!o.type)return String(o);if(t=[formatNode(o)],r=o.children,i=r&&r.length,e=-1,!i)return t[0];for(n&&"number"!=typeof n||(n="");++e<i;)o=r[e],e===i-1?t.push(formatNesting(n+STOP)+inspect(o,n+"   ")):t.push(formatNesting(n+CONTINUE)+inspect(o,n+CHAR_VERTICAL_LINE+"  "));return t.join("\n")}function formatNesting(o){return dim(o)}function compile(o){var n=[];return o?(n=[[o.line||1,o.column||1].join(":")],"offset"in o&&n.push(String(o.offset||0)),n):null}function stringify(o,n){function t(o){var n=compile(o);n&&(e.push(n[0]),n[1]&&i.push(n[1]))}var r=[],e=[],i=[];return t(o),t(n),0!==e.length&&r.push(e.join("-")),0!==i.length&&r.push(i.join("-")),r.join(", ")}function formatNode(o){var n,t,r=o.type,e=o.position||{},i=stringify(e.start,e.end),l=[];o.children?r+=dim("[")+yellow(o.children.length)+dim("]"):"string"==typeof o.value&&(r+=dim(": ")+green(JSON.stringify(o.value))),i&&(r+=" ("+i+")");for(n in o)t=o[n],ignore.indexOf(n)!==-1||null===t||void 0===t||"object"===(void 0===t?"undefined":_typeof(t))&&isEmpty(t)||l.push("["+n+"="+JSON.stringify(t)+"]");return 0!==l.length&&(r+=" "+l.join("")),r}function stripColor(o){return o.replace(COLOR_EXPRESSION,"")}function ansiColor(o,n){function t(t){return"["+o+"m"+t+"["+n+"m"}return t}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o},isEmpty=require("is-empty"),color=!0;try{color="inspect"in require("util")}catch(o){color=!1}module.exports=color?inspect:noColor,inspect.color=noColor.color=inspect,inspect.noColor=noColor.noColor=noColor;var dim=ansiColor(2,22),yellow=ansiColor(33,39),green=ansiColor(32,39),COLOR_EXPRESSION=new RegExp("(?:(?:\\u001b\\[)|\\u009b)(?:(?:[0-9]{1,3})?(?:(?:;[0-9]{0,3})*)?[A-M|f-m])|\\u001b[A-M]","g"),CHAR_HORIZONTAL_LINE="─",CHAR_VERTICAL_LINE="│",CHAR_SPLIT="└",CHAR_CONTINUE_AND_SPLIT="├",CONTINUE=CHAR_CONTINUE_AND_SPLIT+CHAR_HORIZONTAL_LINE+" ",STOP=CHAR_SPLIT+CHAR_HORIZONTAL_LINE+" ",ignore=["type","value","children","position"];

},{"is-empty":46,"util":209}],202:[function(require,module,exports){
"use strict";function first(){return!0}function typeFactory(t){return function(e){return Boolean(e&&e.type===t)}}function matchesFactory(t){return function(e){var o;for(o in t)if(e[o]!==t[o])return!1;return!0}}function is(t,e,o,r,n){var i=null!==r&&void 0!==r,f=null!==o&&void 0!==o;if("string"==typeof t)t=typeFactory(t);else if(null===t||void 0===t)t=first;else if("object"===(void 0===t?"undefined":_typeof(t)))t=matchesFactory(t);else if("function"!=typeof t)throw new Error("Expected function, string, or object as test");if(f&&("number"!=typeof o||o<0||o===1/0))throw new Error("Expected positive finite index or child node");if(i&&(!is(null,r)||!r.children))throw new Error("Expected parent node");if(!e||!e.type||"string"!=typeof e.type)return!1;if(i!==f)throw new Error("Expected both parent and index");return Boolean(t.call(n,e,o,r))}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};module.exports=is;
...
},{"unist-util-visit":206}],205:[function(require,module,exports){
"use strict";function stringify(o){return o&&"object"===(void 0===o?"undefined":_typeof(o))?has(o,"position")||has(o,"type")?location(o.position):has(o,"start")||has(o,"end")?location(o):has(o,"line")||has(o,"column")?position(o):null:null}function position(o){return o&&"object"===(void 0===o?"undefined":_typeof(o))||(o={}),index(o.line)+":"+index(o.column)}function location(o){return o&&"object"===(void 0===o?"undefined":_typeof(o))||(o={}),position(o.start)+"-"+position(o.end)}function index(o){return o&&"number"==typeof o?o:1}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o},has=require("has");module.exports=stringify;

},{"has":14}],206:[function(require,module,exports){
"use strict";function visit(n,t,r,i){function u(n,i,u){var l;return i=i||(u?0:null),t&&n.type!==t||(l=r(n,i,u||null)),n.children&&l!==!1?e(n.children,n):l}function e(n,t){for(var r,e=i?-1:1,l=n.length,o=(i?l:-1)+e;o>-1&&o<l;){if((r=n[o])&&u(r,o,t)===!1)return!1;o+=e}return!0}"function"==typeof t&&(i=r,r=t,t=null),u(n)}module.exports=visit;
...
},{"./support/isBuffer":208,"_process":113,"inherits":207}],210:[function(require,module,exports){
...
"use strict";function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var C_NEWLINE="\n",C_FENCE="|";module.exports=function(e){return function(){function t(t,o,r){var i=t.now(),s=c.exec(o);if(s&&0===s.index&&!r){for(var n=[],p=[],a=0;(a=o.indexOf(C_NEWLINE))!==-1;){var l=o.indexOf(C_NEWLINE,a+1),d=l!==-1?o.slice(a+1,l):o.slice(a+1);if(d[0]!==C_FENCE)break;var u=d.slice(d.startsWith(C_FENCE+" ")?2:1);n.push(d),p.push(u),o=o.slice(a+1)}var E=p.join(C_NEWLINE),f=""+s[0]+C_NEWLINE+n.join(C_NEWLINE),N=t(f),C=this.enterBlock(),k=this.tokenizeBlock(E,i);return C(),N({type:"custom",children:k,data:{hName:"div",hProperties:{className:e[s[1]]}}})}}var o=(arguments.length>0&&void 0!==arguments[0]&&arguments[0],Object.keys(e).map(escapeRegExp).join("|")),c=new RegExp("\\[\\[("+o+")\\]\\]"),r=this.Parser,i=r.prototype.blockTokenizers,s=r.prototype.blockMethods;i.custom_blocks=t,s.splice(s.indexOf("fencedCode")+1,0,"custom_blocks");var n=r.prototype.interruptParagraph,p=r.prototype.interruptList,a=r.prototype.interruptBlockquote;n.splice(n.indexOf("fencedCode")+1,0,["custom_blocks"]),p.splice(p.indexOf("fencedCode")+1,0,["custom_blocks"]),a.splice(a.indexOf("fencedCode")+1,0,["custom_blocks"])}};

},{}],216:[function(require,module,exports){
"use strict";var blockPlugin=require("./block");module.exports=blockPlugin;

},{"./block":215}],217:[function(require,module,exports){
"use strict";var inlinePlugin=require("./inline");module.exports=inlinePlugin;

},{"./inline":218}],218:[function(require,module,exports){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}module.exports=function(){function e(e,r){var n=t.map(function(t){return e.indexOf(t,r)});return Math.min.apply(Math,_toConsumableArray(n))}function r(){function r(e,r,t){var n=i.exec(r);if(n){if(0!==n.index)return!0;if(t)return!0;e(n[0])({type:"text",value:n[0]})}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];r.locator=e;var t=this.Parser,n=t.prototype.inlineTokenizers,o=t.prototype.inlineMethods;n.keep_entities=r,o.splice(o.indexOf("text"),0,"keep_entities")}var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:["&"],n=t.map(escapeRegExp).join("|"),i=new RegExp("("+n+")");return r};

},{}],219:[function(require,module,exports){
arguments[4][217][0].apply(exports,arguments)
},{"./inline":220,"dup":217}],220:[function(require,module,exports){
"use strict";function shifter(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1;return function(){return function(i){visit(i,"heading",function(i){if(t)return i.depth+t<=1?void(i.depth=1):i.depth+t>=6?void(i.depth=6):void(i.depth+=t)})}}}var visit=require("unist-util-visit");module.exports=shifter;

},{"unist-util-visit":206}],221:[function(require,module,exports){
...
},{"unist-util-visit":206}],222:[function(require,module,exports){
arguments[4][217][0].apply(exports,arguments)
},{"./inline":223,"dup":217}],223:[function(require,module,exports){
"use strict";function locator(t,e){return t.indexOf(DOUBLE,e)}function inlinePlugin(){function t(t,e,i){if(this.options.gfm&&e.charAt(0)===C_PIPE&&e.charAt(1)===C_PIPE&&!e.startsWith(C_PIPE.repeat(4))&&!whitespace(e.charAt(2))){var n="",r="",o="",a="",s=1,c=e.length,l=t.now();for(l.column+=2,l.offset+=2;++s<c;){if(!((n=e.charAt(s))!==C_PIPE||r!==C_PIPE||o&&whitespace(o)))return!!i||t(DOUBLE+a+DOUBLE)({type:"kbd",children:this.tokenizeInline(a,l),data:{hName:"kbd"}});a+=r,o=r,r=n}}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];t.locator=locator;var e=this.Parser,i=e.prototype.inlineTokenizers,n=e.prototype.inlineMethods;i.kbd=t,n.splice(n.indexOf("text"),0,"kbd");var r=this.Compiler;if(null!=r){r.prototype.visitors.kdb=function(t){return"||"+this.all(t).join("")+"||"}}}var whitespace=require("is-whitespace-character"),C_PIPE="|",DOUBLE="||";module.exports=inlinePlugin;

},{"is-whitespace-character":49}],224:[function(require,module,exports){
arguments[4][217][0].apply(exports,arguments)
},{"./inline":225,"dup":217}],225:[function(require,module,exports){
"use strict";function locator(r,e){var t=-1,n=!0,i=!1,s=void 0;try{for(var a,o=Object.keys(markers)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var l=a.value;if((t=r.indexOf(l,e))!==-1)return t}}catch(r){i=!0,s=r}finally{try{!n&&o.return&&o.return()}finally{if(i)throw s}}return t}function inlinePlugin(){function r(r,e,t){var n=!0,i=!1,s=void 0;try{for(var a,o=Object.keys(markers)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var l=a.value;this.escape.includes(l)||this.escape.push(l)}}catch(r){i=!0,s=r}finally{try{!n&&o.return&&o.return()}finally{if(i)throw s}}var u=e[0],f=r.now();if(f.column+=1,f.offset+=1,markers.hasOwnProperty(u)&&!e.startsWith(u+SPACE)&&!e.startsWith(u+u)){for(var c=1;e[c]!==u&&c<e.length;c++);if(c===e.length)return;if(t)return!0;r(e.substring(0,c+1))({type:markers[u],children:this.tokenizeInline(e.substring(1,c),f),data:{hName:markers[u]}})}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];r.locator=locator;var e=this.Parser,t=e.prototype.inlineTokenizers,n=e.prototype.inlineMethods;t.sub_super=r,n.splice(n.indexOf("text"),0,"sub_super")}var SPACE=" ",markers={"~":"sub","^":"sup"};module.exports=inlinePlugin;
