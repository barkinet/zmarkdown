...
"use strict";var fs=require("fs"),unified=require("unified"),reParse=require("remark-parse"),math=require("remark-math");math[0][0]=require("./monkey-patched/remark-math/inline");var katex=require("./monkey-patched/rehype-katex"),stringify=require("rehype-stringify"),remark2rehype=require("remark-rehype"),inspect=require("unist-util-inspect"),headingShifter=require("./packages/heading-shift"),htmlBlocks=require("./packages/html-blocks"),escapeEscaped=require("./packages/escape-escaped"),kbd=require("./packages/kbd"),customBlocks=require("./packages/custom-blocks"),subSuper=require("./packages/sub-super"),emoticons=require("./packages/emoticons"),numberedFootnotes=require("./packages/numbered-footnotes"),footnotesTitles=require("./packages/footnotes-title"),fromFile=function(e){return fs.readFileSync(e)},processor=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.headingShift;return unified().use(reParse,{gfm:!0,commonmark:!1,yaml:!1,footnotes:!0,blocks:[]}).use(headingShifter,r||0).use(numberedFootnotes).use(remark2rehype,{allowDangerousHTML:!0}).use(footnotesTitles,"Retourner au texte de la note $id").use(customBlocks,{secret:"spoiler",s:"spoiler",information:"information ico-after",i:"information ico-after",question:"question ico-after",q:"question ico-after",attention:"warning ico-after",a:"warning ico-after",erreur:"error ico-after",e:"error ico-after"}).use(math).use(htmlBlocks).use(escapeEscaped,["&"]).use(kbd).use(subSuper).use(emoticons,{":ange:":"/static/smileys/ange.png",":colere:":"/static/smileys/angry.gif",o_O:"/static/smileys/blink.gif",";)":"/static/smileys/clin.png",":diable:":"/static/smileys/diable.png",":D":"/static/smileys/heureux.png","^^":"/static/smileys/hihi.png",":o":"/static/smileys/huh.png",":p":"/static/smileys/langue.png",":magicien:":"/static/smileys/magicien.png",":colere2:":"/static/smileys/mechant.png",":ninja:":"/static/smileys/ninja.png","x(":"/static/smileys/pinch.png",":pirate:":"/static/smileys/pirate.png",":'(":"/static/smileys/pleure.png",":lol:":"/static/smileys/rire.gif",":honte:":"/static/smileys/rouge.png",":-°":"/static/smileys/siffle.png",":)":"/static/smileys/smile.png",":soleil:":"/static/smileys/soleil.png",":(":"/static/smileys/triste.png",":euh:":"/static/smileys/unsure.gif",":waw:":"/static/smileys/waw.png",":zorro:":"/static/smileys/zorro.png"}).use(katex,{inlineDoubleDisplay:!0}).use(stringify)},parse=function(e){return function(r){return processor(e).parse(r)}},transform=function(e){return function(r){return processor(e).runSync(r)}},render=function(e){return function(r){return processor(e).stringify(r)}},renderString=function(e){return function(r){return render(e)(transform(e)(parse(e)(r)))}},renderFile=function(e){return function(r){return renderString(e)(fromFile(r))}};module.exports=function(e){return{inspect:inspect,parse:parse(e),transform:transform(e),renderFile:renderFile(e),renderString:renderString(e)}};

},{"./monkey-patched/rehype-katex":2,"./monkey-patched/remark-math/inline":3,"./packages/custom-blocks":217,"./packages/emoticons":219,"./packages/escape-escaped":220,"./packages/footnotes-title":222,"./packages/heading-shift":223,"./packages/html-blocks":225,"./packages/kbd":226,"./packages/numbered-footnotes":228,"./packages/sub-super":229,"fs":5,"rehype-stringify":132,"remark-math":134,"remark-parse":136,"remark-rehype":185,"unified":197,"unist-util-inspect":202}],2:[function(require,module,exports){
"use strict";function parseMathHtml(e){return unified().use(parse,{fragment:!0,position:!1}).parse(e)}var visit=require("unist-util-visit"),katex=require("katex"),unified=require("unified"),parse=require("rehype-parse"),position=require("unist-util-position");module.exports=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return null==e.throwOnError&&(e.throwOnError=!1),function(r,i){return visit(r,"element",function(r){var t="span"===r.tagName&&r.properties.className&&r.properties.className.includes("inlineMath"),s=r.properties.className&&r.properties.className.includes("inlineMathDouble")||"div"===r.tagName&&"math"===r.properties.className;if(t||s){var a=void 0;try{a=katex.renderToString(r.children[0].value,{displayMode:s})}catch(t){if(e.throwOnError)throw t;i.message(t.message,position.start(r)),a=katex.renderToString(r.children[0].value,{displayMode:s,throwOnError:!1,errorColor:e.errorColor},"katex-parse-error")}var n=parseMathHtml(a).children[0];Object.assign(r.properties,{className:r.properties.className}),r.children=[n]}}),r}};

},{"katex":53,"rehype-parse":117,"unified":197,"unist-util-position":204,"unist-util-visit":207}],3:[function(require,module,exports){
"use strict";function locator(e,t){return e.indexOf("$",t)}var ESCAPED_INLINE_MATH=/^\\\$/,INLINE_MATH=/^\$((?:\\\$|[^$])+)\$/,INLINE_MATH_DOUBLE=/^\$\$((?:\\\$|[^$])+)\$\$/;module.exports=function(){function e(e,t,i){var r=!0,n=INLINE_MATH_DOUBLE.exec(t);n||(n=INLINE_MATH.exec(t),r=!1);var a=ESCAPED_INLINE_MATH.exec(t);if(a)return!!i||e(a[0])({type:"text",value:"$"});if(n){if(i)return!0;var o=n[1].trim();return e(n[0])({type:"inlineMath",value:o,data:{hName:"span",hProperties:{className:"inlineMath"+(r?" inlineMathDouble":"")},hChildren:[{type:"text",value:o}]}})}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];e.locator=locator;var t=this.Parser,i=t.prototype.inlineTokenizers,r=t.prototype.inlineMethods;i.math=e,r.splice(r.indexOf("text"),0,"math");var n=this.Compiler;if(null!=n){n.prototype.visitors.inlineMath=function(e){return"$"+e.value+"$"}}};
...
},{"trim":194}],13:[function(require,module,exports){
...
},{"repeat-string":186}],14:[function(require,module,exports){
...
},{"camelcase":18,"has":16,"hastscript":39,"property-information":116,"vfile-location":211}],18:[function(require,module,exports){
...
},{"./all":22,"ccount":6,"comma-separated-tokens":12,"kebab-case":77,"property-information":116,"space-separated-tokens":188,"stringify-entities":191,"xtend":215}],26:[function(require,module,exports){
...
},{"./omission":28,"./one":35,"html-void-elements":42}],27:[function(require,module,exports){
...
},{"./omission":29,"./util/siblings":33,"./util/white-space-left":34,"hast-util-is-element":19,"unist-util-is":203}],28:[function(require,module,exports){
...
},{"has":16}],30:[function(require,module,exports){
...
},{"./closing":27,"./omission":29,"./util/first":31,"./util/place":32,"./util/siblings":33,"./util/white-space-left":34,"has":16,"hast-util-is-element":19,"unist-util-is":203}],31:[function(require,module,exports){
...
},{"hast-util-whitespace":38,"unist-util-is":203}],35:[function(require,module,exports){
...
},{"./all":22,"./comment":23,"./doctype":24,"./element":25,"./raw":36,"./text":37,"has":16}],36:[function(require,module,exports){
...
},{"stringify-entities":191,"xtend":215}],38:[function(require,module,exports){
...
},{"camelcase":40,"comma-separated-tokens":12,"hast-util-parse-selector":20,"property-information":116,"space-separated-tokens":188}],40:[function(require,module,exports){
...
},{"has":16,"unist-util-visit":207}],81:[function(require,module,exports){
...
},{"./one":109,"trim":194}],83:[function(require,module,exports){
...
},{"./all":82,"unist-builder":200}],84:[function(require,module,exports){
...
},{"unist-builder":200}],87:[function(require,module,exports){
...
},{"detab":13,"unist-builder":200}],88:[function(require,module,exports){
...
},{"unist-builder":200}],91:[function(require,module,exports){
...
},{"unist-builder":200}],94:[function(require,module,exports){
...
},{"collapse-white-space":11,"unist-builder":200}],98:[function(require,module,exports){
...
},{"../all":82,"../wrap":110,"unist-builder":200}],101:[function(require,module,exports){
...
},{"../all":82,"../wrap":110,"unist-builder":200}],104:[function(require,module,exports){
...
},{"../all":82,"../wrap":110,"unist-util-position":204}],106:[function(require,module,exports){
...
},{"trim-lines":192,"unist-builder":200}],107:[function(require,module,exports){
...
},{"./footer":84,"./handlers":96,"./one":109,"mdast-util-definitions":80,"unist-builder":200,"unist-util-generated":201,"unist-util-position":204,"unist-util-visit":207,"xtend":215}],109:[function(require,module,exports){
...
},{"./all":82,"has":16,"unist-builder":200}],110:[function(require,module,exports){
...
},{"unist-builder":200}],111:[function(require,module,exports){
...
},{"character-entities":9,"character-entities-legacy":8,"character-reference-invalid":10,"has":16,"is-alphanumerical":45,"is-decimal":47,"is-hexadecimal":49}],114:[function(require,module,exports){
(function (process){
...
},{"hast-util-from-parse5":17,"parse5/lib/parser":126,"xtend":215}],118:[function(require,module,exports){
...
},{"../tokenizer":128,"./html":120}],120:[function(require,module,exports){
...
},{"../common/html":120,"../parser/open_element_stack":127,"../tokenizer":128}],124:[function(require,module,exports){
...
},{"../common/unicode":122}],125:[function(require,module,exports){
...
},{"../common/doctype":118,"../common/foreign_content":119,"../common/html":120,"../common/merge_options":121,"../common/unicode":122,"../location_info/parser_mixin":123,"../tokenizer":128,"../tree_adapters/default":131,"./formatting_element_list":125,"./open_element_stack":127}],127:[function(require,module,exports){
...
},{"../common/html":120}],128:[function(require,module,exports){
...
},{"../common/unicode":122,"../location_info/tokenizer_mixin":124,"./named_entity_trie":129,"./preprocessor":130}],129:[function(require,module,exports){
...
},{"../common/unicode":122}],131:[function(require,module,exports){
...
},{"hast-util-to-html":21,"xtend":215}],133:[function(require,module,exports){
...
},{"trim-trailing-lines":193}],134:[function(require,module,exports){
"use strict";var inlinePlugin=require("./inline"),blockPlugin=require("./block");module.exports=[[inlinePlugin],[blockPlugin]];

},{"./block":133,"./inline":135}],135:[function(require,module,exports){
...
},{"./lib/parser.js":150,"unherit":196,"xtend":215}],137:[function(require,module,exports){
module.exports=[
  "address",
  "article",
  "aside",
...
},{"parse-entities":113}],139:[function(require,module,exports){
...
},{"./block-elements":137}],140:[function(require,module,exports){
...
},{"unist-util-remove-position":205,"xtend":215}],150:[function(require,module,exports){
...
},{"./decode":138,"./defaults":139,"./parse":149,"./set-options":151,"./tokenize/auto-link":152,"./tokenize/blockquote":153,"./tokenize/break":154,"./tokenize/code-fenced":155,"./tokenize/code-indented":156,"./tokenize/code-inline":157,"./tokenize/definition":158,"./tokenize/delete":159,"./tokenize/emphasis":160,"./tokenize/escape":161,"./tokenize/footnote-definition":162,"./tokenize/heading-atx":163,"./tokenize/heading-setext":164,"./tokenize/html-block":165,"./tokenize/html-inline":166,"./tokenize/link":167,"./tokenize/list":168,"./tokenize/newline":169,"./tokenize/paragraph":170,"./tokenize/reference":171,"./tokenize/strong":172,"./tokenize/table":173,"./tokenize/text":174,"./tokenize/thematic-break":175,"./tokenize/url":176,"./tokenize/yaml":177,"./tokenizer":178,"./unescape":179,"state-toggle":189,"vfile-location":211,"xtend":215}],151:[function(require,module,exports){
...
},{"./defaults":139,"markdown-escapes":78,"xtend":215}],152:[function(require,module,exports){
...
},{"../locate/tag":147,"parse-entities":113}],153:[function(require,module,exports){
...
},{"../util/interrupt":182,"trim":194}],154:[function(require,module,exports){
...
},{"../locate/break":140}],155:[function(require,module,exports){
...
},{"trim-trailing-lines":193}],156:[function(require,module,exports){
...
},{"repeat-string":186,"trim-trailing-lines":193}],157:[function(require,module,exports){
...
},{"../locate/code-inline":141,"is-whitespace-character":51}],158:[function(require,module,exports){
...
},{"../util/normalize":183,"is-whitespace-character":51}],159:[function(require,module,exports){
...
},{"../locate/delete":142,"is-whitespace-character":51}],160:[function(require,module,exports){
...
},{"../locate/emphasis":143,"is-whitespace-character":51,"is-word-character":52,"trim":194}],161:[function(require,module,exports){
...
},{"../locate/escape":144}],162:[function(require,module,exports){
...
},{"../util/normalize":183,"is-whitespace-character":51}],163:[function(require,module,exports){
...
},{"../util/html":181}],166:[function(require,module,exports){
...
},{"../locate/tag":147,"../util/html":181,"is-alphabetical":44}],167:[function(require,module,exports){
...
},{"../locate/link":145,"has":16,"is-whitespace-character":51}],168:[function(require,module,exports){
...
},{"../util/get-indentation":180,"../util/interrupt":182,"../util/remove-indentation":184,"is-decimal":47,"repeat-string":186,"trim":194}],169:[function(require,module,exports){
...
},{"is-whitespace-character":51}],170:[function(require,module,exports){
...
},{"../util/interrupt":182,"is-decimal":47,"trim":194,"trim-trailing-lines":193}],171:[function(require,module,exports){
...
},{"../locate/link":145,"../util/normalize":183,"is-whitespace-character":51}],172:[function(require,module,exports){
...
},{"../locate/strong":146,"is-whitespace-character":51,"trim":194}],173:[function(require,module,exports){
...
},{"is-whitespace-character":51}],174:[function(require,module,exports){
...
},{"../locate/url":148,"is-whitespace-character":51,"parse-entities":113}],177:[function(require,module,exports){
...
},{"collapse-white-space":11}],184:[function(require,module,exports){
...
},{"./get-indentation":180,"repeat-string":186,"trim":194}],185:[function(require,module,exports){
...
},{"mdast-util-to-hast":81}],186:[function(require,module,exports){
...
},{"path":114}],188:[function(require,module,exports){
...
},{"trim":194}],189:[function(require,module,exports){
...
},{"./dangerous.json":190,"character-entities-html4":7,"character-entities-legacy":8,"has":16,"is-alphanumerical":45,"is-hexadecimal":49}],192:[function(require,module,exports){
...
},{"inherits":43,"xtend":215}],197:[function(require,module,exports){
...
},{"bail":4,"extend":198,"has":16,"is-plain-obj":50,"isarray":199,"trough":195,"vfile":212,"x-is-function":213,"x-is-string":214}],198:[function(require,module,exports){
...
},{"object-assign":112}],201:[function(require,module,exports){
...
},{"is-empty":48,"util":210}],203:[function(require,module,exports){
...
},{"unist-util-visit":207}],206:[function(require,module,exports){
...
},{"has":16}],207:[function(require,module,exports){
...
},{"./support/isBuffer":209,"_process":115,"inherits":208}],211:[function(require,module,exports){
...
},{"_process":115,"has":16,"is-buffer":46,"path":114,"replace-ext":187,"unist-util-stringify-position":206,"x-is-string":214}],213:[function(require,module,exports){
...
"use strict";function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var C_NEWLINE="\n",C_FENCE="|";module.exports=function(e){function o(o,t,s){var r=o.now(),i=c.exec(t);if(i&&0===i.index&&!s){for(var n=[],p=[],a=0;(a=t.indexOf(C_NEWLINE))!==-1;){var l=t.indexOf(C_NEWLINE,a+1),E=l!==-1?t.slice(a+1,l):t.slice(a+1);if(E[0]!==C_FENCE)break;var d=E.slice(E.startsWith(C_FENCE+" ")?2:1);n.push(E),p.push(d),t=t.slice(a+1)}var u=p.join(C_NEWLINE),N=""+i[0]+C_NEWLINE+n.join(C_NEWLINE),f=o(N),C=this.enterBlock(),k=this.tokenizeBlock(u,r);return C(),f({type:"custom",children:k,data:{hName:"div",hProperties:{className:e[i[1]]}}})}}var t=Object.keys(e).map(escapeRegExp).join("|"),c=new RegExp("\\[\\[("+t+")\\]\\]"),s=this.Parser,r=s.prototype.blockTokenizers,i=s.prototype.blockMethods;r.custom_blocks=o,i.splice(i.indexOf("fencedCode")+1,0,"custom_blocks");var n=s.prototype.interruptParagraph,p=s.prototype.interruptList,a=s.prototype.interruptBlockquote;n.splice(n.indexOf("fencedCode")+1,0,["custom_blocks"]),p.splice(p.indexOf("fencedCode")+1,0,["custom_blocks"]),a.splice(a.indexOf("fencedCode")+1,0,["custom_blocks"])};

},{}],217:[function(require,module,exports){
"use strict";var blockPlugin=require("./block");module.exports=blockPlugin;

},{"./block":216}],218:[function(require,module,exports){
"use strict";function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var SPACE=" ";module.exports=function(){function e(e,n){var t=r.exec(e);return t?e[t.index]===SPACE?t.index+1:t.index:-1}function n(e,n,i){var o=r.exec(n);if(o){if(0!==o.index)return!0;if(i)return!0;var s=o[0];s.charAt(s.length-1)===SPACE&&(s=s.substring(0,s.length-1)),e(s)({type:"image",url:t[s],alt:s})}}var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},i=Object.keys(t).map(escapeRegExp).join("|"),r=new RegExp("(\\s|^)("+i+")(\\s|$)");n.locator=e;var o=this.Parser,s=o.prototype.inlineTokenizers,c=o.prototype.inlineMethods;s.emoticons=n,c.splice(c.indexOf("text"),0,"emoticons")};

},{}],219:[function(require,module,exports){
"use strict";var emoticonsPlugin=require("./emoticons");module.exports=emoticonsPlugin;

},{"./emoticons":218}],220:[function(require,module,exports){
"use strict";var inlinePlugin=require("./inline");module.exports=inlinePlugin;

},{"./inline":221}],221:[function(require,module,exports){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}module.exports=function(){function e(e,r){var n=t.map(function(t){return e.indexOf(t,r)});return Math.min.apply(Math,_toConsumableArray(n))}function r(e,r,t){var n=i.exec(r);if(n){if(0!==n.index)return!0;if(t)return!0;e(n[0])({type:"text",value:n[0]})}}var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:["&"],n=t.map(escapeRegExp).join("|"),i=new RegExp("("+n+")");r.locator=e;var a=this.Parser,o=a.prototype.inlineTokenizers,p=a.prototype.inlineMethods;o.keep_entities=r,p.splice(p.indexOf("text"),0,"keep_entities")};

},{}],222:[function(require,module,exports){
"use strict";function plugin(){function i(i){visit(i,"element",e)}function e(i,e,s){if("a"===i.tagName&&i.properties.className&&i.properties.className.includes("footnote-backref")){var r=s.properties.id.slice(3),n=t.indexOf("$id"),o=void 0;n!==-1&&(o=t.split(""),o.splice(n,3,r),o=o.join("")),o||(o=r),i.properties.title=o}}var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"";return i}var visit=require("unist-util-visit");module.exports=plugin;

},{"unist-util-visit":207}],223:[function(require,module,exports){
arguments[4][220][0].apply(exports,arguments)
},{"./inline":224,"dup":220}],224:[function(require,module,exports){
...
},{"unist-util-visit":207}],225:[function(require,module,exports){
...
},{"unist-util-visit":207}],226:[function(require,module,exports){
arguments[4][220][0].apply(exports,arguments)
},{"./inline":227,"dup":220}],227:[function(require,module,exports){
...
},{"is-whitespace-character":51}],228:[function(require,module,exports){
...
},{"unist-util-visit":207}],229:[function(require,module,exports){
arguments[4][220][0].apply(exports,arguments)
},{"./inline":230,"dup":220}],230:[function(require,module,exports){
