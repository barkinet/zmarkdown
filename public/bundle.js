...
"use strict";var fs=require("fs"),unified=require("unified"),reParse=require("remark-parse"),math=require("remark-math"),katex=require("rehype-katex"),stringify=require("rehype-stringify"),remark2rehype=require("remark-rehype"),inspect=require("unist-util-inspect"),htmlBlocks=require("./packages/html-blocks"),escapeEscaped=require("./packages/escape-escaped"),kbd=require("./packages/kbd"),customBlocks=require("./packages/custom-blocks"),fromFile=function(e){return fs.readFileSync(e)},processor=unified().use(reParse,{gfm:!0,commonmark:!1,yaml:!1,footnotes:!0,blocks:[]}).use(remark2rehype,{allowDangerousHTML:!0}).use(customBlocks({secret:"spoiler",s:"spoiler",information:"information ico-after",i:"information ico-after",question:"question ico-after",q:"question ico-after",attention:"warning ico-after",a:"warning ico-after",erreur:"error ico-after",e:"error ico-after"})).use(math).use(htmlBlocks).use(escapeEscaped()).use(kbd).use(katex).use(stringify),parse=function(e){return processor.parse(e)},transform=function(e){return processor.runSync(e)},render=function(e){return processor.stringify(e)},renderFile=function(e){return render(transform(parse(fromFile(e))))},renderString=function(e){return render(transform(parse(e)))};module.exports={parse:parse,transform:transform,inspect:inspect,renderFile:renderFile,renderString:renderString};
