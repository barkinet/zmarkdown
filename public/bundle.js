...
"use strict";function escapeRegExp(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}var C_NEWLINE="\n",C_FENCE="|";module.exports=function(e){return function(){function t(t,o,i){var r=t.now(),s=c.exec(o);if(s&&0===s.index&&!i&&0===o.indexOf("[[")){for(var n=[],p=[],a=0;(a=o.indexOf(C_NEWLINE))!==-1;){var l=o.indexOf(C_NEWLINE,a+1),d=l!==-1?o.slice(a+1,l):o.slice(a+1);if(d[0]!==C_FENCE)break;var u=d.slice(d.startsWith(C_FENCE+" ")?2:1);n.push(d),p.push(u),o=o.slice(a+1)}var E=p.join(C_NEWLINE),f=""+s[0]+C_NEWLINE+n.join(C_NEWLINE),N=t(f),C=this.enterBlock(),k=this.tokenizeBlock(E,r);return C(),N({type:"custom",children:k,data:{hName:"div",hProperties:{className:e[s[1]]}}})}}var o=(arguments.length>0&&void 0!==arguments[0]&&arguments[0],Object.keys(e).map(escapeRegExp).join("|")),c=new RegExp("\\[\\[("+o+")\\]\\]"),i=this.Parser,r=i.prototype.blockTokenizers,s=i.prototype.blockMethods;r.custom_blocks=t,s.splice(s.indexOf("fencedCode")+1,0,"custom_blocks");var n=i.prototype.interruptParagraph,p=i.prototype.interruptList,a=i.prototype.interruptBlockquote;n.splice(n.indexOf("fencedCode")+1,0,["custom_blocks"]),p.splice(p.indexOf("fencedCode")+1,0,["custom_blocks"]),a.splice(a.indexOf("fencedCode")+1,0,["custom_blocks"])}};
...
"use strict";function plugin(){return transformer}function transformer(t){visit(t,"raw",visitor)}function visitor(t,e,i){var r=void 0;i&&(r="p"!==i.tagName?{type:"element",tagName:"p",properties:{},children:[{type:"text",value:t.value}]}:{type:"text",value:t.value},i.children[e]=r)}var visit=require("unist-util-visit");module.exports=plugin;

},{"unist-util-visit":206}],222:[function(require,module,exports){
arguments[4][217][0].apply(exports,arguments)
},{"./inline":223,"dup":217}],223:[function(require,module,exports){
"use strict";function locator(e,t){return e.indexOf("||",t)}function inlinePlugin(){function e(e,t,i){var n=/\|\|(.+?)\|\|/.exec(t);if(n){if(0!==n.index)return!0;if(i)return!0;e(n[0])({type:"kbd",data:{hName:"kbd",hChildren:[{type:"text",value:n[1]}]}})}}arguments.length>0&&void 0!==arguments[0]&&arguments[0];e.locator=locator;var t=this.Parser,i=t.prototype.inlineTokenizers,n=t.prototype.inlineMethods;i.kbd=e,n.splice(n.indexOf("text"),0,"kbd");var r=this.Compiler;if(null!=r){r.prototype.visitors.kdb=function(e){return"||"+e.data.hChildren[0].value+"||"}}}module.exports=inlinePlugin;
